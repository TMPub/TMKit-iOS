 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `TMModel` protocol for custom methods.
 ...
 @code
     ...
     @property (nonatomic, strong) TMAuthor *author;
     @end
     ...
     int main() {
         ...
         TMBook *book = [TMBook tm_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book tm_modelToJSONString];
 ...
 @code
     @interface TMShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation TMShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self tm_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self tm_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self tm_modelCopy]; }
     - (NSUInteger)hash { return [self tm_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self tm_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (TMModel)
 ...
 */
+ (nullable instancetype)tm_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)tm_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)tm_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)tm_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)tm_modelToJSONObject;
 ...
 */
- (nullable NSData *)tm_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)tm_modelToJSONString;
 ...
 */
- (void)tm_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)tm_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)tm_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (TMModel)

/// Creates and returns a dictionary from a json directly.
/// @param json A json dictionary of `NSDictionary`, `NSString` or `NSData`.
/// Example: {"user1":{"name","Mary"}, "user2": {name:"Joe"}}
+ (NSDictionary *)tm_dictionaryWithJSON:(id)json;
 ...
 */
+ (nullable NSDictionary *)tm_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<TMModel>' to your class header.
 */
@protocol TMModel <NSObject>
@optional
...
/**
 ...
 Example:
 @code
        @class TMCircle, TMRectangle, TMLine;
 
        @implementation TMShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [TMCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [TMRectangle class];
